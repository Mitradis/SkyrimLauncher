    ...
    public static class FuncClear
    {
        ...
        public static List<string> ignoreList()
        {
            return new List<string>() {
                ...
                "data|meshes|actors|character|animations|osexbadboys",
                "data|meshes|actors|character|animations|osexbadgirls",
                "data|meshes|actors|character|animations|osexdualwield",
                "data|meshes|actors|character|animations|osexvanilladoggy",
                "data|meshes|actors|character|animations|osexvanillakneeling",
                "data|meshes|actors|character|animations|osexvanillamissionary",
                "data|meshes|actors|character|animations|osexvanillastanding",
                "data|meshes|actors|character|animations|osexvanillatumble",
                "data|meshes|actors|character|animations|osexwizardsex",
                ...
                "data|run for your lives.bsa",
                "data|run for your lives.esp",
                ...
                "data|skse|plugins|consoleplugin.dll",
