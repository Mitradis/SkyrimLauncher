...
namespace SkyrimSELauncher
{
    public partial class FormMain : Form
    {
        ...
        public static string pathMyDoc = FuncFiles.pathAddSlash(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), "My Games", "Skyrim Special Edition"));
        ...
        public FormMain()
        {
            ...
            if (File.Exists(pathLauncherINI))
            {
                ...
                string temp = FuncParser.stringRead(pathLauncherINI, "Buttons", "ButtonNameFNIS");
                if (temp != null)
                {
        ...
        void button_ClearDirectory_Click(object sender, EventArgs e)
        {
            ...
            if (FuncMisc.dialogResult(textClearDirectory, textConfirmTitle))
            {
                ...
                FuncFiles.deleteAny(FuncFiles.pathAddSlash(Path.GetFullPath(pathGameFolder + "..")) + "Skyrim Special Edition Mods");
        ...
        public void refreshStyle()
        {
            ...
            button_FNIS.BackgroundImage = button_FNIS.Enabled ? BMbuttonFull : BMbuttonFullPressed;
